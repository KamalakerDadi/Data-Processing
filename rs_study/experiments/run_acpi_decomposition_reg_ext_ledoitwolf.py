...
columns = ['atlas', 'measure', 'classifier', 'scores', 'iter_shuffle_split',
           ...
           'min_region_size_in_mm3', 'covariance_estimator']
results = dict()
...
dimensions = [40, 60, 80, 100, 120, 150]
folder_name = name + str(n_iter) + 'dictlearn_reg_ext_ledoitwolf'
for model in ['dictlearn']:
