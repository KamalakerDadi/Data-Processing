...
gm_mask = nidatasets.fetch_icbm152_brain_gm_mask(threshold=0.2)
...
folder_name = name + str(n_iter) + '_basc_reg_ext_ledoitwolf'
...
results_csv.to_csv(folder_name + str(dim) + '.csv')
print("Done................")
